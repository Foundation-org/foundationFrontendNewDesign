...
export default function SummaryCard({ headerIcon, headerTitle, headerRight, isPublicProfile, children }: Props) {
  return (
    <div>
      <div className="flex items-center justify-between rounded-t-[10px] border-x-[1.85px] border-t-[1.85px] border-blue-200 bg-blue-200 px-5 py-[10px] dark:border-gray-100 dark:bg-accent-100">
