  ...
  const buttonClasses = classNames(
    ...
    },
    {
      ...
      "px-2 text-[8.951px] md:text-[17.554px] font-[500] text-center h-[34.3px] taller:h-[52px] md:h-[67.2px] w-fit border-[1px] border-gray-200 dark:border-white whitespace-nowrap":
        size === "medium",
      "px-2 text-[8.951px] md:text-[17.554px] font-[500] text-center h-[34.3px] taller:h-[52px] md:h-[67.2px] w-full border-[1px] border-gray-200 dark:border-white whitespace-nowrap":
        size === "login-btn",
