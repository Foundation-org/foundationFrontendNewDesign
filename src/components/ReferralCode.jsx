...
const ReferralCode = ({
  ...
  return (
    <div className="relative w-[90vw] laptop:w-[52.6rem]">
      <div className="social-blue-gradiant relative flex items-center gap-[10px] rounded-t-[9.251px] px-[15px] py-1 tablet:gap-4 tablet:rounded-t-[26px] tablet:px-[30px] tablet:py-[8px] dark:bg-gradient-to-tr dark:from-accent-100 dark:to-accent-100">
      ...
      <form
        ...
        className="px-5 py-[14px] tablet:px-[50px] tablet:py-[25px] dark:bg-gray-200"
      >
        <h2 className="text-[9px] font-normal leading-none tracking-[0.15px] text-[#828282] tablet:text-[20px] tablet:leading-6 dark:text-gray-300">
          Enter your registration code for completing registration process.
        </h2>
        <h1 className="mt-1 text-[12px] font-medium leading-normal text-[#7C7C7C] tablet:mb-7 tablet:mt-5 tablet:text-[25px] dark:text-gray-300">
          Referral Code
        </h1>
        <input
          type="text"
          ...
          className="hide_number_input_arrows hide_number_input_arrows2 autofill_text_color dark:bg-dark peer w-full rounded-[2px] border-b-[1.4px] border-[#C0C0C0] bg-transparent pr-8 text-[10px] transition-colors focus:border-b-[1.4px] focus:border-[#C0C0C0] focus:outline-none tablet:text-[22.9px] short:py-0 dark:border-white dark:text-gray-300 dark:focus:border-white"
        />
