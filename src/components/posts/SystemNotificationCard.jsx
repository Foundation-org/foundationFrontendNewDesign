...
const SystemNotificationCard = ({ post }) => {
  ...
  return (
    <div className="flex flex-col gap-2 rounded-[13.842px] border-[1.846px] border-[#D9D9D9] bg-[#F4F8FF] px-7 pb-[15px] pt-[14px] tablet:gap-4 tablet:px-[44px] tablet:py-6">
