...
const Typography = ({ children, variant = 'textBase', color = '', align = 'left', className }) => {
  const variants = {
    textTitle: 'tall:text-[32px] text-[20.396px] md:text-[40px] 5xl:text-[52px] font-[700] text-black dark:text-white',
    ...
    textSmall: 'text-[10.512px] md:text-[20px] font-[400] leading-[34.49px] text-[#667085] dark:text-white',
