  ...
  <button
    className={classNames(
      ...
      variant === 'auth'
        ...
        : '',
      variant === 'addOption'
        ? 'addoption-boxShadow h-[1.375rem] w-fit max-w-fit gap-[0.27rem] rounded-[0.28688rem] bg-[#D9D9D9] text-[0.625rem] font-normal  text-[#435059] tablet:h-[3.125rem] tablet:rounded-[0.9375rem] tablet:text-[1.25rem]'
        : '',
      variant === 'addOption'
      ...
      variant === 'personal-work'
        ...
        : '',
      variant === 'social-btn'
        ? 'h-[36px] w-fit whitespace-nowrap rounded-[0.28688rem] border-[1px] border-gray-200 bg-white px-2 text-center text-[2.5vw] font-[500] text-black dark:border-white dark:bg-dark-gray dark:text-white sm:h-[50px] sm:text-[2.3vw] lg:h-[60px] lg:text-[1vw] tablet:h-[3.125rem] tablet:rounded-[0.9375rem]'
        : '',
      variant === 'getintouch'
