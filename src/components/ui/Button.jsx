  ...
  <button
    className={classNames(
      ...
      variant === 'submit-green'
        ...
        : '',
      variant === 'topics'
        ? 'whitespace-nowrap border px-[4.9px] py-[6.5px] text-[0.57944rem] font-semibold focus:outline-none focus:ring-0 tablet:border-[1.86px] tablet:px-[12px] tablet:py-[13px] tablet:text-[20px] tablet:leading-[20px]'
        : '',
      className,
    )}
    {...props}
