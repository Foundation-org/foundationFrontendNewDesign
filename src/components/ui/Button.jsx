  ...
  <button
    className={classNames(
      ...
      variant === 'cancel'
        ...
        : '',
      variant === 'submit'
        ? 'addoption-boxShadow min-w-[4.875rem] tablet:min-w-[10.8125rem] laptop:min-w-[12vw] px-[6.63px] laptop:px-[17px]  bg-gradient-to-tr from-[#6BA5CF] to-[#389CE3] text-[0.625rem] font-semibold text-white tablet:text-[1.25rem] '
        : '',
