  ...
  <button
    className={classNames(
      ...
      variant === 'hollow-submit2'
        ? 'h-[1.375rem] min-w-[4.875rem] border-[1.428px] border-[#6BA5CF] bg-gradient-to-tr px-[6.63px] py-[3.8px] text-[10px] font-semibold leading-normal text-[#6BA5CF] tablet:h-[3.125rem] tablet:min-w-[10.8125rem] tablet:border-2 tablet:text-[1.25rem]  tablet:leading-none laptop:px-[17px]'
        : '',
