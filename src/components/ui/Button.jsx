...
export const Button = ({ className, children, rounded, variant, ...props }) => (
  <button
    className={classNames(
      ...
      rounded ? 'rounded' : '',
      variant === 'auth'
        ? 'h-[36px] w-full max-w-[297px] rounded-[6.043px] border-[1.463px] border-[#E4D9D9] bg-white text-[9px] font-medium text-black 2xl:rounded-[11.703px] tablet:h-[60px] tablet:rounded-[11.703px] tablet:text-[17.554px] dark:border-gray-100 dark:bg-accent-100 dark:text-gray-300'
        : '',
      variant === 'addOption'
      ...
      variant === 'submit'
        ...
        : '',
      variant === 'g-submit'
        ? 'h-[1.375rem] w-full rounded-[0.28688rem] bg-green-200 px-[6.63px] text-[0.625rem] font-semibold text-white tablet:h-[3.125rem] tablet:rounded-[0.9375rem] tablet:text-[1.25rem] laptop:px-[17px]'
        : '',
      variant === 'verification-badge-edit'
        ? 'addoption-boxShadow h-[1.375rem] min-w-[4.875rem] rounded-[0.28688rem] bg-[#FAD308] px-[6.63px] text-[0.625rem] font-semibold text-white tablet:h-[3.125rem] tablet:min-w-[10.8125rem] tablet:rounded-[0.9375rem] tablet:text-[1.25rem] laptop:px-[17px] dark:bg-yellow-200'
        : '',
      ...
      variant === 'hollow-submit'
        ? 'h-[1.375rem] min-w-[4.875rem] rounded-[7.28px] border-[1.428px] border-[#389CE3] bg-gradient-to-tr px-[6.63px] py-[3.8px] text-[10px] font-semibold leading-normal text-[#389CE3] tablet:h-[3.125rem] tablet:min-w-[10.8125rem] tablet:rounded-[15.2px] tablet:border-[3px] tablet:text-[20.73px] tablet:leading-none laptop:rounded-[12px]  laptop:px-[17px] laptop:text-[25px] dark:border-gray-300 dark:text-gray-300'
        : '',
      variant === 'hollow-submit2'
        ? 'h-[25px] min-w-[4.875rem] whitespace-nowrap rounded-[0.28688rem] border-[1.428px] border-[#6BA5CF] bg-gradient-to-tr px-1 py-[3.8px] text-[10px] font-semibold leading-normal text-[#6BA5CF] tablet:h-[40px] tablet:min-w-[12rem] tablet:rounded-[9px]  tablet:border-2 tablet:text-[1.25rem] tablet:leading-none laptop:w-full laptop:px-[17px] dark:border-white-200 dark:bg-gray-200 dark:text-white-200'
        : '',
      ...
      variant === 'hollow-welcome'
        ...
        : '',
      variant === 'change'
        ? 'addoption-boxShadow h-[1.375rem] w-[4.875rem] rounded-[0.28688rem] bg-[#FDD503] text-[0.625rem] font-semibold text-white disabled:border-[1.428px] disabled:border-[#FDD503] disabled:bg-transparent disabled:text-[#FDD503] tablet:h-[3.125rem] tablet:w-[10.8125rem] tablet:rounded-[0.9375rem] tablet:text-[1.25rem] dark:bg-yellow-200 disabled:dark:text-[#FDD503]'
        : '',
      variant === 'change-outline'
        ? 'h-[1.375rem] w-[4.875rem] rounded-[0.28688rem] border-[1.428px] border-[#FDD503] text-[0.625rem] font-semibold text-[#FDD503] disabled:bg-transparent disabled:text-[#FDD503] tablet:h-[3.125rem] tablet:w-[10.8125rem] tablet:rounded-[0.9375rem] tablet:border-[3px] tablet:text-[1.25rem] dark:border-yellow-200 disabled:dark:text-[#FDD503]'
        : '',
      variant === 'result'
      ...
      variant === 'personal-work'
        ...
        : '',
      variant === 'social-btn'
        ? 'dark:bg-dark-gray h-[36px] w-fit whitespace-nowrap rounded-[0.28688rem] border-[1px] border-gray-200 bg-white px-2 text-center text-[2.5vw] font-[500] text-black sm:h-[50px] sm:text-[2.3vw] lg:h-[60px] lg:text-[1vw] tablet:h-[3.125rem] tablet:rounded-[0.9375rem] dark:border-white dark:text-white'
        : '',
      variant === 'getintouch'
