...
const PopUp = ({
  ...
  return (
    ...
    >
      <Box
        sx={mergedStyle}
        className={`${customClasses} ${remove ? 'z-[2000]' : 'z-[1000]'} h-[90vh] w-fit min-w-[334px] max-w-[676px] overflow-y-auto border-none outline-none tablet:w-full laptop:max-w-[845px]`}
      >
