        ...
        <div className="mb-2 flex tablet:mb-5">
          <div className="w-full rounded-[5.387px] border border-white-500 tablet:rounded-[15px] tablet:border-[3px]">
            ...
            <TextareaAutosize
              ...
              value={categoryName}
              // className="w-full resize-none rounded-[5.128px] border border-white-500 bg-white px-[9.24px] py-[4px] text-[0.625rem] font-medium leading-[13px] text-[#7C7C7C] focus-visible:outline-none tablet:rounded-l-[10.3px] tablet:border-[3px] tablet:px-[18px] tablet:py-[10px] tablet:text-[18px] tablet:leading-[18px] laptop:rounded-[0.625rem] dark:border-[#0D1012] dark:bg-[#0D1012] dark:text-[#7C7C7C]"
              className="flex w-full resize-none items-center bg-white px-[9.24px] py-[6.84px] pr-2 text-[0.625rem] font-normal leading-[0.625rem] text-[#7C7C7C] focus-visible:outline-none dark:text-[#7C7C7C] tablet:rounded-[10px] tablet:px-[11px] tablet:py-3 tablet:text-[18px] tablet:leading-[18px]"
            />
            {/* <button
