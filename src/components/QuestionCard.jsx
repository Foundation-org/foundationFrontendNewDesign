      ...
      <div className="flex items-center mb-7">
        ...
        <div className="w-full flex gap-[42px] justify-end mr-[30px] mb-1">
          <button
            ...
            } shadow-inner inset-0  rounded-[15px] py-2 px-5 text-[#EAEAEA] text-[20px] font-semibold leading-normal mt-12 ml-[18px] w-[173px]`}
          >
            Start
          </button>
          <button className="rounded-[15px] py-2 px-5 text-[#20D47E] dark:text-[#EAEAEA] text-[20px] font-semibold leading-normal mt-12 ml-[18px] w-[173px] border-[3px] border-[#20D47E] dark:border-[#7C7C7C]">
            Result
          </button>
        </div>
      </div>
