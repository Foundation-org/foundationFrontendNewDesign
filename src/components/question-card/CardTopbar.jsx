...
const CardTopbar = ({
  ...
  return (
    <div
      className={`flex flex-col justify-between border-[#D9D9D9] px-2 tablet:px-5 ${questStartData.suppressed ? 'rounded-t-[12.3px] border-b-[1.834px] bg-[#FEECEC] py-2 tablet:rounded-t-[13.842px] tablet:py-[10px]' : 'pt-2 tablet:pt-4'}`}
    >
      {questStartData?.suppressed ? (
        <div className="mx-5 flex items-center justify-between text-[0.75rem] font-semibold leading-[15px] text-[#FF2C2C] tablet:text-[1.25rem] tablet:leading-[23px]">
