...
export const EmbededImage = ({ description, url, id }) => {
  ...
  return (
    <div className="mx-[22px] mt-[12px] rounded-[9.183px] border border-white-500 px-4 py-2 dark:border-gray-100 tablet:mx-[60px] tablet:mt-[23px] tablet:border-[2.755px]">
      ...
      {url?.length === 1 ? (
        <img
          src={url[0]}
          className="h-full max-h-[230px] w-full rounded-[4.098px] object-contain tablet:h-[372px] tablet:rounded-[15px]"
