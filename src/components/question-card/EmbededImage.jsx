...
export const EmbededImage = ({ description, url }) => {
  ...
  return (
    <div className="mx-[22px] mt-[12px] rounded-[9.183px] border border-[#DEE6F7] pt-2 tablet:mx-[60px] tablet:mt-[23px] tablet:border-[2.755px]">
      ...
      /> */}
      <Carousel openDialogue={openDialogue} />
    </div>
  );
};
