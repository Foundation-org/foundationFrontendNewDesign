  ...
  return (
    <>
      ...
      <div className="w-full bg-[#F2F3F5]">
        <DashboardLayout>
          <div className="mx-auto flex h-[calc(100dvh-101px)] w-full max-w-[1440px] tablet:h-[calc(100vh-96px)] laptop:mx-[331px] laptop:h-[calc(100vh-70px)] laptop:px-4 desktop:mx-auto desktop:px-0 dark:bg-[#242424]">
