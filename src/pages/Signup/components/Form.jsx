    ...
    <form className="mt-6 flex w-full flex-col gap-11 text-gray-600 dark:text-white 5xl:gap-14 short:gap-[38px]">
      <div className="relative grid w-full grid-cols-[1fr] items-center">
        <Input
          ...
          id="email"
          label="Email Address"
          className="autofill_text_color peer w-full rounded-[2px] border-b-[1.4px] border-[#C0C0C0] bg-white py-1  pr-8 text-[12px] transition-colors focus:border-b-[1.4px] focus:border-[#C0C0C0] focus:outline-none dark:border-white dark:bg-dark dark:focus:border-white md:text-[22.9px] short:py-0 taller:text-[16px]"
