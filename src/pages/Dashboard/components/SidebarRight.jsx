...
const SidebarRight = () => {
  ...
  return (
    <div className="bg-[#131417] h-[calc(100vh-96px)] min-w-[25rem] w-[25rem] pt-20 pl-[1.3rem] pr-[2.1rem]">
      <div className="flex gap-6 mb-11">
        ...
        <div>
          <h4 className="text-[30px] font-semibold leading-normal text-[#D2D2D2]">
            My Profile
          </h4>
          <Anchor className="text-[#BAE2FF]">Edit Profile</Anchor>
          <div className="flex gap-2 mt-3">
            <div className="h-[9px] w-6 bg-[#4A8DBD] rounded-md"></div>
            <div className="h-[9px] w-6 bg-[#323232] rounded-md"></div>
            <div className="h-[9px] w-6 bg-[#323232] rounded-md"></div>
            <div className="h-[9px] w-6 bg-[#323232] rounded-md"></div>
            <div className="h-[9px] w-6 bg-[#323232] rounded-md"></div>
            <div className="h-[9px] w-6 bg-[#323232] rounded-md"></div>
      ...
      {sidebarList.map((item) => (
        <div className="flex gap-4 items-center mb-4" key={item.id}>
          ...
          <div className="w-full flex items-center justify-between text-[18px] font-semibold leading-normal">
            <h5>{item.title}</h5>
            <h5>{item.value}</h5>
          </div>
        </div>
