...
const SidebarLeft = ({ columns, setColumns }) => {
  ...
  return (
    <>
      <div className="no-scrollbar hidden h-full min-h-[calc(100vh-96px)] w-[18.25rem] min-w-[18.25rem] flex-col items-center justify-between overflow-y-auto border-r-4 border-[#F3F3F3] bg-white text-[#535353] laptop:flex 5xl:w-[23rem] 5xl:min-w-[23rem] dark:border-white dark:bg-[#0A0A0C] dark:text-white">
