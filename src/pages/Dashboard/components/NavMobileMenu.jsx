...
const navMenuList = [
  {
    title: 'News',
    path: '/news',
    icon: `/assets/topbar/news.svg`,
    allowedRole: 'public',
  },
  { title: 'Treasury', path: '/treasury', icon: `/assets/topbar/news.svg`, allowedRole: 'public' },
  { title: 'Verification Badges', path: '/profile/verification-badges', icon: `/assets/topbar/news.svg` },
  { title: 'Feedback Given', path: '/profile/feedback-given', icon: `/assets/topbar/news.svg` },
  { title: 'Feedback received', path: '/profile/feedback', icon: `/assets/topbar/news.svg` },
  {
    title: 'Shared Posts',
    path: '/profile/shared-links',
    icon: `/assets/svgs/sharelink.svg`,
  },
  { title: 'My Lists', path: '/profile/lists', icon: `/assets/topbar/news.svg` },
  { title: 'Shared Articles', path: '/profile/shared-articles', icon: `/assets/topbar/news.svg` },
  { title: 'Post Activity', path: '/profile/post-activity', icon: `/assets/topbar/news.svg` },
  { title: 'User Setting', path: '/profile/user-settings', icon: `/assets/topbar/news.svg` },
  { title: 'Help', path: '/help/about', icon: `/assets/topbar/news.svg`, allowedRole: 'public' },
  {
    title: 'Seldon',
    path: 'seldon-ai',
    icon: `/assets/topbar/news.svg`,
