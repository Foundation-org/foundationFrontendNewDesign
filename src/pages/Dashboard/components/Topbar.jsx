...
const Topbar = () => {
  ...
  return (
    <div
      ...
      } fixed top-0 flex h-[4.18rem] min-h-[4.18rem] w-full flex-col items-center justify-between pb-2 tablet:h-[116px] tablet:min-h-[116px] laptop:h-[92px] laptop:min-h-[92px] laptop:flex-row laptop:pb-0`}
    >
      {/* logo */}
