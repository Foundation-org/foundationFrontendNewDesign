...
const Topbar = () => {
  ...
  return (
    <div className="bg-[#389CE3]">
      <div className="static mx-auto flex h-[4.18rem] min-h-[4.18rem] w-full max-w-[1378px] flex-col items-center justify-between pb-2 tablet:h-[116px] tablet:min-h-[116px] laptop:h-[92px] laptop:min-h-[92px] laptop:flex-row laptop:pb-0">
        {/* logo */}
