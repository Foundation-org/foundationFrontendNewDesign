...
const Contributions = () => {
  ...
  return (
    <div>
      <h1 className="mb-[25px] ml-[26px] mt-[6px] text-[12px] font-bold leading-normal text-[#4A8DBD] tablet:mb-[54px] tablet:ml-[156px] tablet:text-[32px] tablet:font-semibold">
        My Contributions
      </h1>
      <div className="shadow-inside relative mx-[106px] hidden h-[183px] rounded-[45px] tablet:block">
      ...
      <div className="flex flex-col gap-[30px] tablet:hidden">
        <div className="shadow-inside relative mx-6 h-[82px] rounded-[11.4px] tablet:mx-[106px] tablet:h-[183px] tablet:rounded-[45px]">
            ...
            {firstHalf?.map((item) => (
              <div className="w-full" key={item.id}>
                <div className="flex flex-col items-center justify-center">
                  ...
                  />
                  <h4 className="text-center text-[8px] font-semibold leading-normal text-[#7C7C7C] tablet:text-[18px]">
                    {item.title.split(" ")[0]}
                  </h4>
                  <h4 className="mb-[10px] text-center text-[8px] font-semibold leading-normal text-[#7C7C7C] tablet:mb-6 tablet:text-[18px]">
                    {item.title.split(" ")[1]}
                  </h4>
                  <h1 className="text-center text-[16px] font-semibold leading-[14px] text-[#7C7C7C] 2xl:text-[35px] tablet:text-[24px]">
                    {item.value}
                  </h1>
                </div>
              </div>
