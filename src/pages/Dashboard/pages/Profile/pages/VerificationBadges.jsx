...
const VerificationBadges = () => {
  ...
  const checkPersonal = (itemType) =>
    fetchUser?.badges?.some((i) => i.type === itemType);
  ...
  const checkSocial = (itemType) =>
    fetchUser?.badges?.some((i) => i.accountName === itemType);
      ...
      >
        ...
        {socials.map((item, index) => (
          ...
          >
            ...
            <Button
              color={
                checkSocial(item.accountName) ? "yellow" : item.ButtonColor
              }
              onClick={() => {
                !checkSocial(item.accountName) &&
                  window.open(
                    `${import.meta.env.VITE_API_URL}${item.link}`,
                    "_self",
                  );
              }}
            >
