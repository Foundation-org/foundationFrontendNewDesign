...
const Tabs = ({ handleSelectedTab, active }) => {
  return (
    <div className="mx-[19vw] mb-[10px] mt-[15px] flex justify-around gap-[9.21px] tablet:mx-[20vw] tablet:my-[26px] tablet:gap-[19.9px] laptop:mx-[20vw] laptop:mb-[67px] laptop:mt-[50px] laptop:gap-9">
      <Link
        to={''}
        className={`${
