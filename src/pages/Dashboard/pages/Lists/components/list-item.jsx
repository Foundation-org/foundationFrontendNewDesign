...
const ListItem = ({ post, setCategoryId, categoryItem, setPostId, setDeletePostPopup }) => {
  ...
  return (
    ...
    >
      <div
        className={`${
          isDragging ? 'border-blue-300' : 'border-white-500 bg-white dark:border-gray-250 dark:bg-[#0D1012]'
        } flex w-full items-center rounded-[4.7px] border tablet:rounded-[10px] tablet:border-[3px]`}
      >
        <div className="flex w-full items-center rounded-[4.734px] bg-white-500 dark:bg-gray-250">
          <div
            className={`${
          ...
          <div
            className={`${
              isDragging ? 'border-blue-300 bg-[#F2F6FF] dark:bg-[#0D1012]' : 'border-white-500 dark:border-gray-250'
            } flex w-full justify-between rounded-r-[4.7px] bg-white dark:bg-[#0D1012] tablet:rounded-r-[10px]`}
          >
