...
const TreasuryLayout = () => {
  ...
  return (
    <div
      className={`${location.pathname !== '/treasury/ledger' ? 'mx-auto max-w-[1440px] laptop:mx-[331px] desktop:mx-auto' : ''} w-full bg-[#F2F3F5] tablet:h-[calc(100vh-70px)] dark:bg-[#242424]`}
    >
      <Breadcrumb />
