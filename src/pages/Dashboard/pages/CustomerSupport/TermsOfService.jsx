...
const TermsOfService = () => {
  return (
    <div className="mb-12 bg-white pb-5 tablet:rounded-t-[0.86513rem]">
      ...
      <div className="term_policy_paragraph mt-[5px] space-y-[0.63rem] px-8 text-[#707175] tablet:mt-[15px] tablet:space-y-2 tablet:px-16">
      ...
      <ul className="mt-[10px] list-decimal space-y-[0.63rem] px-8 text-[#707175] tablet:space-y-2 tablet:px-16">
