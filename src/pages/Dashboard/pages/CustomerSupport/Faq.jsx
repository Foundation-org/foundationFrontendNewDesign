...
const Faq = () => {
  ...
  return (
    <div>
      <Topbar />
      <div className="no-scrollbar h-[calc(100dvh-58px)]  w-full overflow-scroll overflow-y-auto bg-white text-[#707175] tablet:h-[calc(100dvh-96px)] laptop:h-[calc(100dvh-70px)]">
