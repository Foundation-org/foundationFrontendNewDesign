    ...
    <div className="flex flex-row items-center gap-[25px] ml-[22px] mr-[42px] tablet:ml-[60px] tablet:mr-[112px]">
      <div className="flex w-full justify-between rounded-[10px] bg-white dark:bg-[#0D1012]">
        <div className="flex w-full items-center">
          ...
          <div className="flex h-[27px] pb-[1px] w-full items-center justify-between rounded-r-[4.89px] border-y border-r border-[#DEE6F7] dark:border-[#0D1012] tablet:h-[51px] tablet:rounded-r-[10px] tablet:border-y-[3px] tablet:border-r-[3px]">
