    ...
    <div className="flex flex-row items-center gap-[25px]">
      <div className="flex w-full justify-between rounded-[10px] bg-white dark:bg-accent-100">
        <div className="flex w-full items-center">
          ...
          <div className="flex h-[27px] w-full items-center justify-between rounded-r-[4.89px] border-y border-r border-white-500  tablet:h-[51px] tablet:rounded-r-[10px] tablet:border-y-[3px] tablet:border-r-[3px] dark:border-gray-100">
            <h1 className="w-full pl-2 text-[0.625rem] font-normal leading-normal text-[#7C7C7C] tablet:pl-5 tablet:text-[20.7px] laptop:text-[18px] dark:text-white-600">
              {answer}
            </h1>
          </div>
        </div>
