              ...
              item.picUrlStatus.tooltipName !== 'Answer is Verified' && (
                <div key={item.id} className="flex w-full items-center justify-between">
                  <div className="flex w-full">
                    ...
                    /> */}
                    <button
                      className={`border-white-500 relative rounded-r-[5.128px] border-y border-r bg-white text-[0.5rem] font-semibold leading-none dark:border-[#0D1012] dark:bg-[#0D1012] tablet:rounded-r-[10.3px] tablet:border-y-[3px] tablet:border-r-[3px] tablet:text-[1rem] laptop:rounded-r-[0.625rem] laptop:text-[1.25rem] ${item.picUrlStatus.color}`}
                    >
