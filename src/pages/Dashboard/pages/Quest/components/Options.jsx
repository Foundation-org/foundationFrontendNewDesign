        ...
        <div className="w-full">
          <div className="flex w-full items-center justify-center">
            <div className="flex w-full rounded-r-[0.33rem] bg-transparent tablet:w-full tablet:rounded-[10.3px] laptop:rounded-[10px]">
              ...
              <div
                className={`${
                  isDragging
                    ...
                    : 'border-white-500 bg-white dark:border-[#0D1012] dark:bg-[#0D1012]'
              ...
              >
                <div className="flex h-[75%] w-[50px] items-center justify-center border-l border-white-500 tablet:w-[99.58px] tablet:border-l-[3px] laptop:w-[134px]">
