    ...
    >
      {!allowInput ? (
        ...
        <div className="flex w-full items-center justify-center">
          <div className="mx-[21px] flex w-full rounded-r-[0.33rem] bg-transparent dark:bg-[#0D1012] tablet:ml-[54px] mr-[22px] tablet:mr-[70px] tablet:w-full tablet:rounded-[10.3px] laptop:rounded-2xl">
