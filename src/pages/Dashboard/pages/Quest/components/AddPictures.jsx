          ...
          {getMediaStates.picUrlStatus.tooltipName !== 'Question is Verified' && (
            <div className="flex">
              ...
              <textarea
                ...
                value={getMediaStates.picUrl}
                placeholder="Paste Flickr share link or url here..."
                className="border-white-500 w-full resize-none rounded-l-[5.128px] border-y border-l bg-white px-[9.24px] pb-2 pt-[7px] text-[0.625rem] font-medium leading-[13px] text-[#7C7C7C] focus-visible:outline-none dark:border-[#0D1012] dark:bg-[#0D1012] dark:text-[#7C7C7C] tablet:rounded-l-[10.3px] tablet:border-y-[3px] tablet:border-l-[3px] tablet:px-[18px] tablet:py-[11.6px] tablet:text-[1.296rem] tablet:leading-[23px] laptop:rounded-l-[0.625rem] laptop:py-[13px] laptop:text-[1.25rem]"
              />
              <button
