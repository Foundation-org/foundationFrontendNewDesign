...
const OpenChoice = () => {
  ...
  return (
    ...
    >
      ...
      <div className="border-white-500 mx-[30px] mt-2 flex flex-col gap-[5px] rounded-[0.30925rem] border bg-[#FCFCFC] py-[10px] dark:bg-[#212224] tablet:mx-[50px] tablet:gap-[15px] tablet:rounded-[16px] tablet:border-[3px] tablet:py-[20px]">
        ...
        <div className="border-white-500 mx-[15px] flex items-center justify-between rounded-[0.30925rem] border px-[8.62px] py-[6px] tablet:rounded-[16px] tablet:border-[3px] tablet:px-[20.26px] tablet:pb-[13.72px] tablet:pt-[14.83px] laptop:mx-[28px] laptop:px-7 laptop:py-[20px]">
          <h5 className="w-[150px] text-[9px] font-normal leading-normal text-[#7C7C7C] tablet:w-[300px] tablet:text-[18.662px] laptop:w-full laptop:text-[20px]">
