...
const Quest = () => {
  ...
  return (
    <div className="w-full overflow-y-scroll bg-[#F2F3F5] pb-[140px] pt-5 md:pb-12 tablet:h-[calc(100vh-116px)] tablet:pt-[60px] laptop:h-[calc(100vh-70px)] dark:bg-[#242424]">
