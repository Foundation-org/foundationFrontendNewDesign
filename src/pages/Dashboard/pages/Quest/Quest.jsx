...
const Quest = () => {
  ...
  return (
    <div className=" w-full overflow-y-scroll bg-[#F3F3F3] pb-8 pt-[20px] dark:bg-[#242424] md:pb-12 tablet:h-[calc(100vh-116px)] tablet:pt-[60px] laptop:h-[calc(100vh-96px)]">
