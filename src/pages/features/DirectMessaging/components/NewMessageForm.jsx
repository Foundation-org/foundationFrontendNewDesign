...
export default function NewMessageForm() {
  ...
  return (
    <div className="space-y-[9px] tablet:space-y-[15px]">
      ...
      <div className="relative h-fit w-full max-w-[730px] space-y-[9px] rounded-[15px] border-2 border-[#D9D9D9] bg-white px-[11px] py-[15px] dark:border-gray-100 dark:bg-gray-200 dark:text-gray-300 tablet:mx-auto tablet:mb-8 tablet:space-y-[15px] tablet:px-5 tablet:py-6">
        {directMessageState.to !== 'Participants' && (
          <div className="flex rounded-[3.817px] border border-[#DEE6F7] bg-[#FDFDFD] px-3 py-[6px] dark:border-gray-100 dark:bg-accent-100 tablet:rounded-[9.228px] tablet:border-[2.768px] tablet:px-5 tablet:py-3">
            <p className="text-gray text-[10px] font-semibold leading-[10px] dark:text-white tablet:text-[22px] tablet:leading-[22px]">
              To:
            </p>
            <input
              type="text"
              value={directMessageState.to}
              className="text-gray-1 w-full bg-transparent pl-2 text-[10px] leading-[10px] focus:outline-none dark:bg-accent-100 dark:text-white-400 tablet:text-[22px] tablet:leading-[22px]"
              onChange={(e) => {
        ...
        <div className="flex items-center rounded-[3.817px] border border-[#DEE6F7] bg-[#FDFDFD] px-3 py-[6px] text-[10px] dark:border-gray-100 dark:bg-accent-100 tablet:rounded-[9.228px] tablet:border-[2.768px] tablet:px-5 tablet:py-3 tablet:text-[22px]">
          ...
          <input
            ...
            className="text-gray-1 w-full bg-transparent px-2 text-[10px] leading-[10px] focus:outline-none dark:bg-accent-100 dark:text-white-400 tablet:text-[22px] tablet:leading-[22px]"
            onChange={(e) => {
              const inputValue = e.target.value;
        ...
        >
          <p className="text-gray w-fit whitespace-nowrap text-[10px] font-semibold leading-[10px] dark:text-white tablet:text-[22px] tablet:leading-[22px]">
            Read Reward:
          </p>
          <input
            type="number"
            ...
            className="text-gray-1 w-fit bg-transparent pl-2 text-[10px] leading-[10px] focus:outline-none dark:bg-accent-100 dark:text-white-400 tablet:text-[22px] tablet:leading-[22px]"
            onChange={(e) => {
        ...
        <h1 className="text-gray px-2 py-[5.7px] text-[8.52px] font-normal italic leading-none dark:text-[#D3D3D3] tablet:px-[18px] tablet:py-3 tablet:text-[19px]">
      ...
      <div className="relative h-fit w-full max-w-[730px] rounded-[15px] border-2 border-[#D9D9D9] bg-white px-[11px] py-[15px] dark:border-gray-100 dark:bg-gray-200 dark:text-gray-300 tablet:mx-auto tablet:px-5 tablet:py-6">
        <div className="text-gray flex justify-between rounded-[3.817px] border border-[#DEE6F7] bg-[#FDFDFD] px-3 py-[6px] dark:border-gray-100 dark:bg-accent-100 dark:text-white-400 tablet:rounded-[9.228px] tablet:border-[2.768px] tablet:px-5 tablet:py-3">
