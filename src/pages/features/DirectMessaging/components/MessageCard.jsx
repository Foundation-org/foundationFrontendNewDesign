  ...
  return (
    <div className="h-fit w-full rounded-[8px] border-[1.232px] border-[#D9D9D9] bg-white dark:border-gray-100 dark:bg-gray-200 tablet:mx-0 tablet:rounded-[15px] tablet:border-2">
      ...
      <div className="m-3 flex flex-col gap-3 tablet:m-5 tablet:gap-5">
        <h1 className="text-gray-1 text-[12.145px] font-semibold leading-[12.145px] tablet:text-[22px] tablet:leading-[22px]">
          {item.subject}
        </h1>
        ...
        {filter === 'sent' && (
          <div className="flex items-center justify-between gap-[15px]">
            <div className="flex items-center gap-1">
              ...
              />
              <p className="text-gray-1 text-[8.097px] font-normal leading-[8.097px] dark:text-white tablet:text-[14.2px] tablet:leading-[14.2px]">
                {item.send
