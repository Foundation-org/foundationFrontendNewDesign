...
const DirectMessageLayout = () => {
  ...
  return (
    <div className="mx-auto w-full max-w-[1440px] bg-gray-400 pb-8 dark:bg-black md:pb-12 tablet:h-[calc(100vh-96px)] laptop:mx-[331px] laptop:h-[calc(100vh-70px)] desktop:mx-auto">
      <Breadcrumb />
      {location.pathname !== '/direct-messaging/new-message' && (
      ...
      <div
        ref={scrollRef}
        className={`${location.pathname === '/direct-messaging/new-message' ? 'mt-3 tablet:mt-[15px] laptop:h-[calc(100dvh-96px)]' : 'mt-10 tablet:mt-[77.63px] laptop:h-[calc(100dvh-147.6px)]'} h-[calc(100dvh-174px)] overflow-y-auto px-4 no-scrollbar tablet:h-[calc(100dvh-173.63px)] tablet:px-6`}
      >
        <Outlet
