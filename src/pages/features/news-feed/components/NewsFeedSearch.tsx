          ...
          <div className="relative">
            <div className="relative h-[18px] w-full laptop:h-[45px]">
              <input
                ...
                className="peer block h-full w-full appearance-none rounded-[3.55px] border border-[#707175] bg-transparent py-2 pl-5 pr-8 text-[6px] text-[#707175] focus:border-blue-600 focus:outline-none focus:ring-0 dark:border-gray-600 dark:text-gray-300 dark:focus:border-blue-500 tablet:text-[18.23px] laptop:rounded-[10px] laptop:border-2 laptop:text-[18.23px]"
              ...
              <label
                ...
                className="absolute left-[15px] start-1 top-2 z-10 origin-[0] -translate-y-4 scale-75 transform bg-white px-2 text-[8.33px] text-[#707175] duration-300 peer-placeholder-shown:top-1/2 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:scale-100 peer-focus:top-2 peer-focus:-translate-y-4 peer-focus:scale-75 peer-focus:px-2 peer-focus:text-blue-600 dark:bg-gray-200 dark:text-white-100 peer-focus:dark:text-blue-500 tablet:text-[17px] laptop:text-[17px] rtl:peer-focus:left-auto rtl:peer-focus:translate-x-1/4"
              >
                Search
              </label>
            </div>
